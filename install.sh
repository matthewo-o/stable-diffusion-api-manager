...
aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/shiyicode/lora-models/resolve/main/Japanese-doll-likeness.safetensors -d ./stable-diffusion-webui/models/Lora -o Japanese-doll-likeness.safetensors
...
aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/stabilityai/sd-vae-ft-mse-original/resolve/main/vae-ft-mse-840000-ema-pruned.ckpt -d ./stable-diffusion-webui/models/VAE -o vae-ft-mse-840000-ema-pruned.ckpt
